...
This is a sample template for forte-upload-app - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name forte-upload-app --query 'Stacks[].Outputs'
```
